...
- All supported providers (AWS, Azure, Google Cloud, Alibaba Cloud, Okta, Entra, Google Workspace)
- Asset Inventory
- Alerts
- Integrations (Teams, Slack, Webhook)
- ITSM integration (e.g. Jira)
...
- Only manual [syncs](../intro/dictionary.mdx#sync) (excepting the sync after adding a connector)
...
If your needs exceed the scale plan and/or you want a closer collaboration, reach us at [sales@cyscale.com](mailto:ales@cyscale.com).
