...
<Image img={require('/img/jira-connect.png')} alt="Jira OAuth 2.0 Page" className="text--center" />
...
<Image img={require('/img/jira-issue-example.png')} alt="Example of Jira issue created from Cyscale" className="text--center" />
