...
For a more conceptual explanation of how Cyscale turns these signals into one operating model, see the [CNAPP Guide](https://cyscale.com/cloud-security-wiki/cnapp/) and [CSPM Guide](https://cyscale.com/cloud-security-wiki/cspm/).
