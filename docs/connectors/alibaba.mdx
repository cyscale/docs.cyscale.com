...
Once you are ready to connect your Aliyun account(s) and have the required permissions, press the **Create** button from the top-right corner, select **Add Cloud Account**, and choose **Alibaba**. You will be greeted with a simple multi-step process.
