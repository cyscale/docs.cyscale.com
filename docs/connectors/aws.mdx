...
You can also check asset vulnerabilities by navigating to the Vulnerabilities tab or in the Overview Cards section.
...
Each Severity is marked with a color from light yellow to dark red.
