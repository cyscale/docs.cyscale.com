...
If AI Security is enabled for your account, Cyscale may request additional Azure read permissions for AI and Machine Learning resources such as Azure Machine Learning, Azure AI Search, Azure OpenAI, Microsoft Foundry / AI Foundry-related resources, Cognitive Services families, Bot Services, Document Intelligence, Speech, Translator, Language, Computer Vision, and related AI service metadata.

The connector permission update flow can show either:

- a predefined Azure role option, where applicable
- a custom permissions list that you can add to the Cyscale custom role

After updating permissions in Azure, mark the connector as updated in Cyscale and trigger a sync.
