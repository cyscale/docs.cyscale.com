...
The list of Azure resources that Cyscale can handle are listed in the tables below, along with the number of controls that check their configuration
...
| PostgreSQL                    | # of Controls |
| ----------------------------- | ------------- |
| PostgreSQLServer              | 7             |
| PostgreSQLServerConfiguration | 0             |
...
| SQLDatabase                   | 1             |
| SQLServer                     | 5             |
| SQLServerAzureADAdministrator | 0             |
| SQLServerEncryptionProtector  | 0             |
| SQLServerFirewallRule         | 0             |
| SQLServerTableAuditingPolicy  | 0             |

### Identity & Access Management

| Azure Active Directory | # of Controls |
| ---------------------- | ------------- |
| ServicePrincipal       | 0             |
| User                   | 0             |
...
| Container Registry | # of Controls |
| ------------------ | ------------- |
| ContainerRegistry  | 0             |

| Container Service | # of Controls |
| ----------------- | ------------- |
| Cluster           | 1             |
...
In addition, Cyscale offers 50 more Azure controls that are not specific to a service or asset type. These are called cloud-wide controls.
